...
import { AppBar, Button, IconButton, InputBase, Toolbar, useTheme, Box, Menu, MenuItem, Typography } from '@mui/material';
                    ...
                    <FlexBetween>
                        <Button onClick={handleClick} sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", textTransform: "none", gap: "1rem" }}>
                            ...
                            <Box textAlign="left">
                                ...
                                <Typography fontWeight="0.8rem" fontSize="0.75rem" sx={{ color: theme.palette.secondary[200] }} >
                                    {user.occupation}
                                </Typography>
                            </Box>
